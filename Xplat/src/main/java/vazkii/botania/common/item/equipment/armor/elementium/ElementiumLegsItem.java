...
public class ElementiumLegsItem extends ElementiumArmorItem {
	...
	public ElementiumLegsItem(Properties props) {
		super(Type.LEGGINGS, props.component(DataComponents.ATTRIBUTE_MODIFIERS, ItemAttributeModifiers.builder()
				.add(PixieHandler.PIXIE_SPAWN_CHANCE,
						PixieHandler.makeModifier(botaniaRL("leggins_modifier"), 0.15),
